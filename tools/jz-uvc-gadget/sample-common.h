...
/* first sensor */
#define FIRST_SNESOR_NAME 			"sc301IoT"			//sensor name (match with snesor driver name)
#define	FIRST_I2C_ADDR				0x30				//sensor i2c address
#define	FIRST_I2C_ADAPTER_ID		2					//sensor controller number used (0/1/2/3)
#define FIRST_SENSOR_WIDTH			2048				//sensor width
#define FIRST_SENSOR_HEIGHT			1536				//sensor height
...
#define STREAM_FILE_PATH_PREFIX		"/tmp/mnt/sdcard"
#define SNAP_FILE_PATH_PREFIX		"/tmp/mnt/sdcard"
