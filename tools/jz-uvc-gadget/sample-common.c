...
//			IMP_FrameSource_GetI2dAttr(chn[i].index,  &I2dAttr);
//            if (ret < 0) {
//                IMP_LOG_ERR(TAG, "IMP_FrameSource_SetI2dAttr(chn%d) error !\n",  chn[i].index);
//                return -1;
//            }
//            printf("chn->%d, I2dAttr param:%d,%d,%d,%d,%d\n", chn[i].index, I2dAttr.flip_enable, I2dAttr.i2d_enable, I2dAttr.mirr_enable, I2dAttr.rotate_angle, I2dAttr.rotate_enable);


//			IMP_FrameSource_SetI2dAttr(chn[i].index,  &chn[i].fs_chn_attr.i2dattr);
//			if (ret < 0) {
//                IMP_LOG_ERR(TAG, "IMP_FrameSource_SetI2dAttr(chn%d) error !\n",  chn[i].index);
//                return -1;
//            }
...
//                return -1;
//            }
//            printf("after chn->%d, I2dAttr param:%d,%d,%d,%d,%d\n", chn[i].index, I2dAttr.flip_enable, I2dAttr.i2d_enable, I2dAttr.mirr_enable, I2dAttr.rotate_angle, I2dAttr.rotate_enable);
		}
	}
